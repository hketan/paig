...
const RISK_LEVEL = {
    CRITICAL: {LABEL: 'Critical', VALUE: 'CRITICAL', COLOR: '#ee8b8b', DONUTCOLOR: 'E10101'},
    HIGH: {LABEL: 'High', VALUE: 'HIGH', COLOR: '#E101014D', DONUTCOLOR: 'FF6B35'},
    MEDIUM: {LABEL: 'Medium', VALUE: 'MEDIUM', COLOR: '#FFEDB2', DONUTCOLOR: 'FFC233'},
    LOW: {LABEL: 'Low', VALUE: 'LOW', COLOR: '#B2F0D6', DONUTCOLOR: '2CA02C'}
}

const ASSERT_RISK_LEVEL = {
    CRITICAL: {LABEL: 'Critical', VALUE: 'CRITICAL', COLOR: '#B3261E'},
    HIGH: {LABEL: 'High', VALUE: 'HIGH', COLOR: '#FF7901'},
    ELEVATED: {LABEL: 'Elevated', VALUE: 'HIGH', COLOR: '#FFA902'},
    MODERATE: {LABEL: 'Moderate', VALUE: 'MODERATE', COLOR: '#2F940C'},
    LOW: {LABEL: 'Low', VALUE: 'LOW', COLOR: '#48CA1A'}
}

const ASSERT_DATA_SEVERITY_LEVEL = {
    SEVERE: {LABEL: 'Severe', VALUE: 'SEVERE', COLOR: '#B3261E'},
    HIGH: {LABEL: 'High', VALUE: 'HIGH', COLOR: '#FF7901'},
    MODERATE: {LABEL: 'Moderate', VALUE: 'MODERATE', COLOR: '#2F940C'},
    LOW: {LABEL: 'Low', VALUE: 'LOW', COLOR: '#48CA1A'}
}
